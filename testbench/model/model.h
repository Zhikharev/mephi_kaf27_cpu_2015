...
DPI_LINK_DECL DPI_DLLESPEC int or_1 (int, int, int);
DPI_LINK_DECL DPI_DLLESPEC int and_1 (int, int, int);
DPI_LINK_DECL DPI_DLLESPEC int xor_1 (int, int, int);
DPI_LINK_DECL DPI_DLLESPEC int nor_1 (int, int, int);
